      ...
      <div className="grid grid-cols-2 items-center justify-center h-[76vh]">
        <div className="font-bold text-6xl text-left leading-20">
          ...
          <motion.div
            ...
            <div className="text-zinc-300 hidden-before">
        ...
        <motion.div
          ...
          <div className="flex justify-end">
            <div className="relative hidden-before">
              ...
              >
                <div className="bg-white h-140 w-110 rounded-full rotate-60 hidden-before"></div>
              </motion.div>
            </div>
          </div>
        </motion.div>
